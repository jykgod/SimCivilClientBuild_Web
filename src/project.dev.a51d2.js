window.__require = function e(t, n, r) {
  ...
  CameraSystem: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "8bdf2/vQ7dP+YutUYBHE+l8", "CameraSystem");
    ...
    var CameraSystem = function(_super) {
      ...
      CameraSystem.prototype.OnStart = function() {
        ResourcesManager_1.ResourcesManager.Instance.loadRes(GloableConstantUtils_1.GloableConstantUtils.GamePrefabPath.concat("GameCamera"), function(error, res) {
          if (error) {
          ...
          MapDataComponent_1.default.instance.cameraNode = node;
        });
      };
      CameraSystem.prototype.OnDestroy = function() {
        MapDataComponent_1.default.instance.cameraNode.destroy();
        MapDataComponent_1.default.instance.cameraNode = null;
      };
      CameraSystem.prototype.OnUpdate = function() {
        if (this.positions.length <= 0) return;
        var playerPos = cc.Vec2.ZERO;
        for (var i = 0; i < this.positions.length; i++) playerPos.addSelf(this.positions[i].position);
        playerPos.divSelf(this.positions.length);
        var temp = playerPos.clone();
        temp.subSelf(MapDataComponent_1.default.instance.centerPosition);
        var mag = temp.mag();
        if (mag * EcsUtility_1.EcsUtility.LogicToUIRatio > 100) {
          temp.mulSelf(100 / (mag * EcsUtility_1.EcsUtility.LogicToUIRatio));
          temp = playerPos.sub(temp);
          if (temp != MapDataComponent_1.default.instance.centerPosition) {
            MapDataComponent_1.default.instance.centerPositionDirty = true;
            MapDataComponent_1.default.instance.centerPosition = temp;
            MapDataComponent_1.default.instance.cameraNode.position = MapDataComponent_1.default.instance.centerPosition.mul(EcsUtility_1.EcsUtility.LogicToUIRatio);
          }
        }
      };
      __decorate([ ECS.inject(MotionControllerComponent_1.default) ], CameraSystem.prototype, "motionControllers", void 0);
      __decorate([ ECS.inject(PositionComponent_1.default) ], CameraSystem.prototype, "positions", void 0);
      return CameraSystem;
    }(ECS.ComponentSystem);
  ...
  GameStateMainNormal: [ function(require, module, exports) {
    ...
    var CameraSystem_1 = require("../../ecs/system/CameraSystem");
    var GameStateMainNormal = function() {
      ...
      GameStateMainNormal.prototype.StateEnter = function() {
        ...
        this.world.addSystem(CameraSystem_1.default);
  ...
  GloableConstantUtils: [ function(require, module, exports) {
    ...
    var GloableConstantUtils = function() {
      ...
      GloableConstantUtils.AtlasPath = "image/atlas/";
      GloableConstantUtils.JsonPath = "json/";
      GloableConstantUtils.mapZIndex = -1e3;
  ...
  GloableUtils: [ function(require, module, exports) {
    ...
    var UIManager_1 = require("../manager/UIManager");
    var UINameEnum_1 = require("../enum/UINameEnum");
    var JsonConfigUtils_1 = require("./JsonConfigUtils");
    ...
    var GloableUtils = function() {
      ...
      GloableUtils.prototype.GetAtalasAndCeilName = function(centerType, roundType, mask, callback) {
        JsonConfigUtils_1.JsonConigUtils.ReadJsonObjectByName("MapAtlasNameConfig", function(error, conf) {
          if (error) {
          ...
          if (centerType == roundType) {
            ...
            var flag = false;
            for (var i = 0; i < conf.length; i++) if (conf[i].other_type == roundType) {
              conf = conf[i];
              flag = true;
              break;
            }
          ...
          ret.id = centerType > roundType ? (255 & mask).toString() : mask.toString();
          callback && callback(ret);
        });
      };
      GloableUtils.GetMaskString = function(mask) {
        var ret = "";
        for (var i = 7; i >= 0; i--) ret += (mask & 1 << i) > 0 ? "1" : "0";
        return ret;
      };
      GloableUtils.tipsPendingQueue = null;
      GloableUtils.dx = [ 1, 0, -1, 1, -1, 1, 0, -1 ];
      GloableUtils.dy = [ -1, -1, -1, 0, 0, 1, 1, 1 ];
      return GloableUtils;
    }();
  ...
  JsonConfigNameEnum: [ function(require, module, exports) {
    ...
    (function(JsonConfigNameEnum) {
      ...
      JsonConfigNameEnum["Map_Atlas_Name"] = "MapAtlasNameConfig";
  ...
  MapCeilComponent: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "1c23eHONW5FebVkWf+cH7oC", "MapCeilComponent");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var MapCeilComponent = function() {
      function MapCeilComponent() {}
      return MapCeilComponent;
    }();
    exports.default = MapCeilComponent;
    cc._RF.pop();
  }, {} ],
  MapCeilTypEnum: [ function(require, module, exports) {
    ...
    (function(MapCeilTypeEnum) {
      ...
      MapCeilTypeEnum[MapCeilTypeEnum["path"] = 1] = "path";
      MapCeilTypeEnum[MapCeilTypeEnum["water"] = 2] = "water";
      MapCeilTypeEnum[MapCeilTypeEnum["end"] = 3] = "end";
    })(MapCeilTypeEnum = exports.MapCeilTypeEnum || (exports.MapCeilTypeEnum = {}));
    cc._RF.pop();
  }, {} ],
  MapCeilUIComponent: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "8c219KeSlBCSKdc1YGPJc40", "MapCeilUIComponent");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var GloableUtils_1 = require("../../tools/GloableUtils");
    var ResourcesManager_1 = require("../../manager/ResourcesManager");
    var EcsUtility_1 = require("../../ecs/utility/EcsUtility");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var MapCeilUIComponent = function(_super) {
      __extends(MapCeilUIComponent, _super);
      function MapCeilUIComponent() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.sprites = [];
        return _this;
      }
      MapCeilUIComponent.prototype.onLoad = function() {
        this.node.active = false;
      };
      MapCeilUIComponent.prototype.update = function(dt) {
        var _this = this;
        if (this.mapCeil.uiDirty) {
          var atlas = this.mapCeil.ceil.Atlas;
          this.node.position = this.mapCeil.pos.mul(EcsUtility_1.EcsUtility.LogicToUIRatio);
          if (null != atlas) {
            this.mapCeil.uiDirty = false;
            ResourcesManager_1.ResourcesManager.Instance.loadAtlas(atlas, function(error, a) {
              if (null != error) {
                Logger.error(error, "MapCeilUIComponent");
                return;
              }
              var masks = _this.mapCeil.ceil.Mask;
              for (var i = 0; i < masks.length; i++) _this.sprites[i].spriteFrame = a.getSpriteFrame(GloableUtils_1.GloableUtils.GetMaskString(masks[i]));
            });
          }
        }
      };
      __decorate([ property([ cc.Sprite ]) ], MapCeilUIComponent.prototype, "sprites", void 0);
      MapCeilUIComponent = __decorate([ ccclass ], MapCeilUIComponent);
      return MapCeilUIComponent;
    }(cc.Component);
    exports.default = MapCeilUIComponent;
    cc._RF.pop();
  }, {
    "../../ecs/utility/EcsUtility": "EcsUtility",
    "../../manager/ResourcesManager": "ResourcesManager",
    "../../tools/GloableUtils": "GloableUtils"
  } ],
  MapCeil: [ function(require, module, exports) {
    ...
    var MapCeil = function() {
      ...
      Object.defineProperty(MapCeil.prototype, "Atlas", {
        get: function() {
          return this._atlas;
        },
        enumerable: true,
      ...
      Object.defineProperty(MapCeil.prototype, "Mask", {
        get: function() {
          return this._mask;
        },
        enumerable: true,
      ...
      MapCeil.prototype.Reset = function(type, roundsType) {
        var _this = this;
        this._mask = [ 0, 0, 0, 0 ];
        var mask = 0;
        var roundType = type;
        for (var i = 0; i < roundsType.length; i++) roundsType[i] == type ? mask = 1 + (mask << 1) : roundType = roundsType[i];
        if (this._type == type && this.mask == mask) return false;
        this._type = type;
        this.mask = mask;
        this._mask[0] = 11 + (128 & mask) + (64 & mask) + ((64 & mask) >> 1) + (16 & mask) + ((16 & mask) >> 2);
        this._mask[1] = 22 + ((64 & mask) << 1) + (64 & mask) + (32 & mask) + (8 & mask) + ((8 & mask) >> 3);
        this._mask[2] = 104 + ((16 & mask) << 3) + (16 & mask) + (4 & mask) + (2 & mask) + ((2 & mask) >> 1);
        this._mask[3] = 208 + ((8 & mask) << 2) + (8 & mask) + ((2 & mask) << 1) + (2 & mask) + (1 & mask);
        if (roundType > type) for (var i = 0; i < 4; i++) this._mask[i] = 255 ^ this._mask[i];
        JsonConfigUtils_1.JsonConigUtils.ReadJsonObjectByName(JsonConfigNameEnum_1.JsonConfigNameEnum.Map_Atlas_Name, function(error, res) {
          var conf = res[type.toString()];
          for (var i = 0; i < conf.length; i++) if (conf[i].other_type == roundType) {
            _this._atlas = conf[i].atlas;
            return;
          }
          _this._atlas = conf[0].atlas;
        });
        return true;
      };
      return MapCeil;
  ...
  MapDataComponent: [ function(require, module, exports) {
    ...
    var MapDataComponent = function() {
      function MapDataComponent() {
        this.centerPosition = cc.Vec2.ZERO;
        this.centerPositionDirty = false;
        this.viewWidth = 0;
        this.viewHeight = 0;
        this.cacheWidth = 50;
        this.cacheHeight = 50;
        this.ceilsData = new Array();
        this.ceilsFromServer = new Array();
        this.mapCeilsInView = new Array();
        this.ceilsPosistionInied = false;
      }
  ...
  MapSystem: [ function(require, module, exports) {
    ...
    var MapDataComponent_1 = require("../sharedComponent/MapDataComponent");
    var MapCeil_1 = require("../../struct/MapCeil");
    var MapCeilComponent_1 = require("../component/MapCeilComponent");
    var GloableConstantUtils_1 = require("../../tools/GloableConstantUtils");
    var GloableUtils_1 = require("../../tools/GloableUtils");
    var ResourcesManager_1 = require("../../manager/ResourcesManager");
    var MapCeilUIComponent_1 = require("../../logic/map/MapCeilUIComponent");
    var EcsUtility_1 = require("../utility/EcsUtility");
    var MapSystem = function(_super) {
      ...
      MapSystem.prototype.OnStart = function() {
        ...
        MapDataComponent_1.default.instance.viewWidth = Math.ceil(cc.Canvas.instance.node.width / EcsUtility_1.EcsUtility.LogicToUIRatio);
        MapDataComponent_1.default.instance.viewHeight = Math.ceil(cc.Canvas.instance.node.height / EcsUtility_1.EcsUtility.LogicToUIRatio);
      ...
      MapSystem.prototype.DealServerData = function() {
        var serverData = MapDataComponent_1.default.instance.ceilsFromServer;
        if (serverData.length > 0) {
          for (var i = 0; i < serverData.length; i++) {
            MapDataComponent_1.default.instance.ceilsData[serverData[i].Position.Item1] || (MapDataComponent_1.default.instance.ceilsData[serverData[i].Position.Item1] = []);
            MapDataComponent_1.default.instance.ceilsData[serverData[i].Position.Item1][serverData[i].Position.Item2] = Math.floor(3 * Math.random());
          }
          MapDataComponent_1.default.instance.ceilsFromServer = new Array();
        }
      };
      MapSystem.prototype.InitCeilsPosition = function() {
        var wNumber = MapDataComponent_1.default.instance.cacheWidth;
        var hNumber = MapDataComponent_1.default.instance.cacheHeight;
        var entityManager = ECS.World.active.EntitisManager;
        for (var i = 0; i < wNumber; i++) {
          var _loop_1 = function(j) {
            var entity = entityManager.CreateAEntity();
            entityManager.addComponent(entity, MapCeilComponent_1.default);
            var mcc = entityManager.GetComponent(entity, MapCeilComponent_1.default);
            mcc.pos = new cc.Vec2(i, j);
            mcc.ceil = new MapCeil_1.default();
            ResourcesManager_1.ResourcesManager.Instance.loadRes(GloableConstantUtils_1.GloableConstantUtils.GamePrefabPath.concat("Ceil"), function(error, res) {
              var node = cc.instantiate(res);
              node.setParent(cc.Canvas.instance.node);
              node.zIndex = GloableConstantUtils_1.GloableConstantUtils.mapZIndex;
              var script = node.getComponent(MapCeilUIComponent_1.default);
              script.mapCeil = mcc;
              mcc.uiNode = node;
            });
            mcc.dirty = true;
          };
          for (var j = 0; j < hNumber; j++) _loop_1(j);
        }
        MapDataComponent_1.default.instance.ceilsPosistionInied = true;
      };
      MapSystem.prototype.UpdateCeilsPosition = function() {
        if (false == MapDataComponent_1.default.instance.ceilsPosistionInied || false == MapDataComponent_1.default.instance.centerPositionDirty) return;
        var H = MapDataComponent_1.default.instance.cacheHeight;
        var W = MapDataComponent_1.default.instance.cacheWidth;
        var C = MapDataComponent_1.default.instance.centerPosition;
        var up = C.y + H / 2;
        var bottom = C.y - H / 2;
        var left = C.x - W / 2;
        var right = C.x + W / 2;
        var viewUp = C.y + MapDataComponent_1.default.instance.viewHeight / 2 + .5;
        var viewBottom = C.y - MapDataComponent_1.default.instance.viewHeight / 2 - .5;
        var viewLeft = C.x - MapDataComponent_1.default.instance.viewWidth / 2 - .5;
        var viewRight = C.x + MapDataComponent_1.default.instance.viewWidth / 2 + .5;
        var dirtyCeilsArr = new Array();
        for (var i = 0; i < this.ceils.length; i++) {
          ...
          true == this.ceils[i].dirty && (this.ceils[i].inView = this.ceils[i].pos.x < viewRight && this.ceils[i].pos.x > viewLeft && this.ceils[i].pos.y < viewUp && this.ceils[i].pos.y > viewBottom);
        }
        MapDataComponent_1.default.instance.centerPositionDirty = false;
      };
      MapSystem.prototype.UpdateCeilsTexture = function() {
        for (var i = 0; i < this.ceils.length; i++) if (this.ceils[i].inView && this.ceils[i].dirty) {
          this.ceils[i].uiNode.active = true;
          var x = Math.round(this.ceils[i].pos.x);
          var y = Math.round(this.ceils[i].pos.y);
          var type = 0;
          var roundType = [ 0, 0, 0, 0, 0, 0, 0, 0 ];
          try {
            var ceilsData = MapDataComponent_1.default.instance.ceilsData;
            var type_1 = ceilsData[x][y];
            for (var k = 0; k < 8; k++) roundType.push(ceilsData[x + GloableUtils_1.GloableUtils.dx[i]][y + GloableUtils_1.GloableUtils.dy[i]]);
          } catch (_a) {
      ...
      __decorate([ ECS.inject(MapCeilComponent_1.default) ], MapSystem.prototype, "ceils", void 0);
      return MapSystem;
    }(ECS.ComponentSystem);
    exports.default = MapSystem;
    cc._RF.pop();
  }, {
    "../../logic/map/MapCeilUIComponent": "MapCeilUIComponent",
    "../../manager/ResourcesManager": "ResourcesManager",
    "../../struct/MapCeil": "MapCeil",
    "../../tools/GloableConstantUtils": "GloableConstantUtils",
    "../../tools/GloableUtils": "GloableUtils",
    "../component/MapCeilComponent": "MapCeilComponent",
    "../sharedComponent/MapDataComponent": "MapDataComponent",
    "../utility/EcsUtility": "EcsUtility"
  } ],
  ...
  PlayerMotionSyncSystem: [ function(require, module, exports) {
    ...
    var PlayerMotionSyncSystem = function(_super) {
      ...
      PlayerMotionSyncSystem.prototype.OnStart = function() {
        EcsUtility_1.EcsUtility.LastSyncMotionTime = new Date();
      };
      PlayerMotionSyncSystem.prototype.OnUpdate = function() {
        var now = new Date();
        if (this.motion.length > 0) {
          var motionV = this.motion[0].v.mul((now - EcsUtility_1.EcsUtility.LastSyncMotionTime) / 1e3);
          this.pos[0].position = this.pos[0].position.add(motionV);
          SimCivil.Contract.IPlayerController.MoveTo(new SimCivil.Contract.ValueTupleFloat({
            Item1: this.pos[0].position.x,
            Item2: this.pos[0].position.y
          }), now);
        }
        EcsUtility_1.EcsUtility.LastSyncMotionTime = now;
      };
  ...
  Player: [ function(require, module, exports) {
    ...
    var Player = function(_super) {
      ...
      Player.prototype.update = function() {
        this.node.position = this.posComp.position.mul(EcsUtility_1.EcsUtility.LogicToUIRatio);
      };
  ...
  ResourcesManager: [ function(require, module, exports) {
    ...
    var ResourcesManager = function() {
      ...
      ResourcesManager.prototype.loadAtlas = function(atlasName, callback) {
        var _this = this;
        this.atlasMap[atlasName] ? callback(null, this.atlasMap[atlasName]) : cc.loader.loadRes(GloableConstantUtils_1.GloableConstantUtils.AtlasPath.concat(atlasName), cc.SpriteAtlas, function(error, atlas) {
          if (!error) {
            _this.atlasMap[atlasName] = atlas;
            atlas.getTexture().setFilters(cc.Texture2D.Filter.NEAREST, cc.Texture2D.Filter.NEAREST);
          }
  ...
  ViewSyncSystem: [ function(require, module, exports) {
    ...
    var ViewSyncSystem = function(_super) {
      ...
      ViewSyncSystem.prototype.OnStart = function() {
        ...
        ViewChangeData_1.default.instance.data = null;
        ViewChangeData_1.default.instance.gotData = false;
      ...
      ViewSyncSystem.prototype.OnUpdate = function() {
        if (null != ViewChangeData_1.default.instance.data && null != this.positions && this.positions.length > 0) {
          var pos = new cc.Vec2(ViewChangeData_1.default.instance.data.Position.Item1, ViewChangeData_1.default.instance.data.Position.Item2);
          if (this.positions[0].position.sub(pos).magSqr() > 1 || false == ViewChangeData_1.default.instance.gotData) {
            Logger.log("\u51fa\u73b0\u5ba2\u6237\u7aef\u548c\u670d\u52a1\u5668\u4f4d\u7f6e\u4e0d\u540c\u6b65\u7684\u95ee\u9898\uff01\u5ba2\u6237\u7aef\u4f4d\u7f6e:" + this.positions[0].position + " ; \u670d\u52a1\u5668\u4f4d\u7f6e:" + pos, "ViewChange");
            EcsUtility_1.EcsUtility.LastSyncMotionTime = new Date();
            if (false == ViewChangeData_1.default.instance.gotData) {
              ViewChangeData_1.default.instance.gotData = true;
              var count_1 = 0;
              var nowx = 0;
              var nowy = 0;
              SimCivil.Contract.IViewSynchronizer.GetAtlas(new SimCivil.Contract.ValueTupleInt32({
                Item1: nowx,
                Item2: nowy
              })).then(function(v) {
                if (!v) return;
                MapDataComponent_1.default.instance.ceilsFromServer = MapDataComponent_1.default.instance.ceilsFromServer.concat(v);
                count_1++;
                9 == count_1 && (MapDataComponent_1.default.instance.centerPositionDirty = true);
              });
              for (var i = 0; i < 8; i++) {
                var nextX = nowx + GloableUtils_1.GloableUtils.dx[i];
                var nextY = nowy + GloableUtils_1.GloableUtils.dy[i];
                SimCivil.Contract.IViewSynchronizer.GetAtlas(new SimCivil.Contract.ValueTupleInt32({
                  Item1: nowx + GloableUtils_1.GloableUtils.dx[i],
                  Item2: nowy + GloableUtils_1.GloableUtils.dy[i]
                })).then(function(v) {
                  if (!v) return;
                  MapDataComponent_1.default.instance.ceilsFromServer = MapDataComponent_1.default.instance.ceilsFromServer.concat(v);
                  count_1++;
